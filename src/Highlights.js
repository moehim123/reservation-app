    ...
    return (
      <main className="p-24">
        <div className="container mx-auto w-full">
          <div className="flex items-center md:items-start space-y-4 md:space-y-0 md:space-x-8 md:flex-row md:justify-between">
            <div className="flex items-center justify-between w-[1080px]">
              <h1 className="text-black text-3xl font-semibold">Specials</h1>
              <button className="w-[157px] h-[39px] px-6 py-2.5 bg-[#78d454] rounded-[18px] shadow backdrop-blur-[8.70px] flex justify-center items-center mt-4">
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            {meals.map((meal, index) => (
              <div key={index} className="bg-[#f2f2f1] w-[280px] rounded-lg overflow-hidden shadow-md">
                <img
                  className="w-[280px] h-[200px] rounded-tl-[18px] rounded-tr-[18px] border-b border-grey"
                  src={meal.image}
                ...
                <div className="p-4">
                  <div className="flex items-center justify-between">
                    <div className="flex space-x-14">
                      ...
                      <div className="w-[27px] h-[27px] bg-[#78d454] rounded-full flex items-center justify-center mt-1 p-4">
